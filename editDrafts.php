                      ...
                      <table class="table table-hover ">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?php
                                    try{
                                      $pdoConnect = new PDO("mysql:host=localhost;dbname=dbcits","root",""); 
                ...
                <div class="col-md-9"> 
                    ...
                    <br>  
                      <div class="card-body js-sweetalert"> 
                        <form method="post" action="editDrafts.php?id=<?php echo $row['id'];?>" enctype="multipart/form-data" onsubmit="return error()">
                        ...
                        <div class="form-group">
                          <div class="input-group">
                            ...
                            <select name="type" class="form-control"> 
                                <option value="volvo"><?php echo $row['type'];?></option>  
                              ...
                              <optgroup label="Comprehensive Cabling">
                                ...
                                <option value="audi">Kawasaki</option>
                              </optgroup> 
                            </select>
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="input-group">
                            ...
                            <textarea class="form-control" rows="2" name="question" id="question"  minlength="5" autofocus="" required=""><?php echo $row['question'];?></textarea>
                          </div> 
                        </div>     
                        ...
                        <div class="form-group">
                          <div class="input-group">
                            ...
                            <textarea class="form-control" rows="5" name="concern" id="concern"  minlength="5" autofocus="" required=""><?php echo $row['concern'];?></textarea>
                          </div> 
                        </div>     
                          ...
                          <button type="submit" name="drafted" class="btn btn-info btn-round"><i class="fa fa-file-text"></i> DRAFT</button>
                          <button type="submit" name="sendDraft" class="btn btn-success btn-round"><i class="fa fa-send"></i> SEND</button> 
                        </div>
                      </form>
                      </div>
                    </div>
