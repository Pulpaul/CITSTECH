                  ...
                  <div class="card js-sweetalert">
                    ...
                    <div class="card-body">
                      <div class="pull-left"> 
                        ...
                        $pdoQuery = "SELECT * FROM tblconcern where user_id = $id and status= 'Drafted' ";
                      ...
                      <table id="myTableq" class="table table-hover table-striped">
                        <thead>  
                          <th>type</th>
                          <th>Question</th>
                          <th>Description</th>
                        ...
                        <tbody> 
                            ...
                            $query =mysqli_query($conn,"SELECT * FROM tblconcern WHERE user_id='$user_id' AND status = 'Drafted' ");
                            $row = mysqli_fetch_array($query);

                            if ($row == 0) {
                              $empty = "<div class='alert alert-default text-center' style='background: #EEE;'><label>You don't have any drafted items</label></div>";
                            }
                            else {
                            $query = "SELECT * FROM tblconcern WHERE user_id='$user_id' AND status = 'Drafted' ORDER BY time_sent DESC ";
                          ...
                          <td class="text-center">
                            <a class="btn btn-info btn-sm btn-fab btn-round" href="viewDrafts.php?id=<?php echo $row['id']; ?>" data-toggle="tooltip" title="View"><i class="fa fa-info-circle"></i></a> 
                            <button class="btn btn-danger btn-sm btn-fab btn-round" data-toggle="tooltip" title="Remove" id="removeDraftsUser"><i class="fa fa-archive"></i></button>
                          </td>
                          </tr>
                        <?php } } ?>
                        </tbody>
