  ...
  <html>
    ...
    <body>
        ...
        <div class="container-fluid" style="overflow-x: hidden;"> 
              ...
              $pdoQuery = "SELECT * FROM tblconcern WHERE user_id = '$id' AND status != 'Trashed' AND status != 'Drafted'  AND status !='Deleted' ";
              ...
              ?>  Items in Outbox. 
                      ...
                      <table id="myTable" class="table table-hover">
                        ...
                        <tbody> 
                            ...
                            $query = mysqli_query($conn,"SELECT * FROM tblconcern WHERE user_id='$user_id' AND status != 'Trashed' AND status != 'Drafted' AND status !='Deleted' ORDER BY time_sent DESC ");
                            ...
                            $query = "SELECT * FROM tblconcern WHERE user_id='$user_id' AND status != 'Trashed' AND status != 'Drafted' AND status !='Deleted' ORDER BY time_sent DESC "; 
                          ...
                          <td class="text-center">
                            ...
                            <a class="btn btn-info btn-sm btn-fab btn-round" href="viewOutbox.php?id=<?php echo $row['id']; ?>" data-toggle="tooltip" title="View"><i class="fa fa-info-circle"></i></a>
                            <button class="btn btn-danger btn-sm btn-fab btn-round" data-toggle="tooltip" title="Remove" id="removeOutboxUser" data-id="<?php echo $row['id']; ?>"><i class="fa fa-archive"></i></button>
                          </td>
                          </tr>
                        <?php } } ?>
                        </tbody>
