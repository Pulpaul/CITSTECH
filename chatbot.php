...
?> 
  <html>
    ...
    <body>
          ...
          <nav class="navbar navbar-inverse navbar-expand-lg bg-white" role="navigation-demo">
            ...
            <div class="container-fluid" style="overflow-x: hidden;"> 
              ...
              $pdoQuery = "SELECT * FROM tblreply WHERE users_id='$id' AND status = 'Trashed' ";
    ...
    width="993"
    height="438"
    src="https://console.dialogflow.com/api-client/demo/embedded/8fc20447-3679-4d98-af30-9739d314348f">
</iframe>
                  <!--<script id="gs-sdk" src='//www.buildquickbots.com/botwidget/v3/demo/static/js/sdk.js?v=3' key="de544465-d3f3-40d5-b0f6-d465fdccfa21" ></script>-->
                </div>
              </div>
            </div>  
