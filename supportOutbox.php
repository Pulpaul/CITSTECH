                    ...
                    <div class="card-body">  
                      <table class="table table-hover">
                        <tbody>
                          ...
                          <tr class="activeness"> 
                            <td class="active"><a href="supportOutbox.php"><label class="btn btn-primary btn-round btn-fab btn-sm"> <i class="fa fa-envelope-open"></i></label> Outbox</a></td>  
                            <td><?php
                  ...
                  <div class="card">
                    ...
                    <div class="card-body"> 
                      <div class="pull-left">
                        ...
                        $pdoQuery = "SELECT * FROM tblreply  WHERE sup_id = '$id' AND status = 'Sent' OR status = 'Deleted' ";
                      ...
                      <table id="myTable" class="table table-hover">
                        <thead> 
                         ...
                         <tbody> 
                          ...
                          $query = mysqli_query($conn,"SELECT * FROM tblreply WHERE sup_id = '$id' AND status = 'Sent' OR status = 'Deleted' ");
                          $row = mysqli_fetch_array($query);

                          if ($row == 0) {
                            $blank = "<div class='alert alert-default text-center' style='background: #EEE;'><label>Your outbox is empty</label></div>";
                          }
                          else {
                          $query1 = mysqli_query($conn,"SELECT * FROM tblreply LEFT JOIN register_user ON users_id = register_user_id WHERE sup_id = '$id' AND status = 'Sent' OR status = 'Deleted' ");
                          ...
                          <tr>   
                            ...
                            <td>
                              <a href="viewOutboxSupport.php?rep_id=<?php echo $row['rep_id']; ?>" class="btn btn-info btn-fab btn-sm btn-round" data-toggle="tooltip"  title="View"><i class="fa fa-info-circle"></i></a> 
                              <button class="btn btn-danger btn-fab  btn-sm btn-round" data-toggle="tooltip" title="Remove" hidden=""><i class="fa fa-archive"></i></button>
                            </td>
                          </tr> 
                        <?php } } ?>
                        </tbody> 
