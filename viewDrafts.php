...
if(!isset($_SESSION["user_id"]))
{
  ...
  $query=mysqli_query($conn,"SELECT * FROM `tblconcern` INNER JOIN register_user WHERE id = '$id' ");
                  ...
                  <div class="card">
                    ...
                    <div class="card-body"> 
                      ...
                      <div class="row">
                        ...
                        <a href="drafts.php" class="btn btn-danger btn-round"><i class="fa fa-mail-reply"></i> Back </a> 
                        <a href="editDrafts.php?id=<?php echo $row['id']; ?>" class="btn btn-success btn-round pull-right"><i class="fa fa-pencil"></i> Edit</a>
                    </div>
                    </div>
                  </div>
                </div>
