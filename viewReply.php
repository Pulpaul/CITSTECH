...
if(!isset($_SESSION["user_id"]))
{
  ...
  $query=mysqli_query($conn,"SELECT * FROM ((`tblreply` INNER JOIN register_user ON sup_id = register_user_id) INNER JOIN tblconcern ON concern_id = id) WHERE rep_id='$rep_id' ");
    ...
    <body>
          ...
          <nav class="navbar navbar-inverse navbar-expand-lg bg-white" role="navigation-demo">
            ...
            <div class="container-fluid" style="overflow-x: hidden;"> 
              ...
              $pdoQuery = "SELECT * FROM tblconcern WHERE user_id = '$id' AND status = 'Trashed' ";
              ...
              ?></td>
                ...
                <div class="col-md-9">
                  <div class="card">
                    <div class="card-header card-header-danger text-center">
                      <i class="fa fa-envelope-open"></i> REPLY
                    </div>
                    <div class="card-body"> 
                      <?php echo $sended; ?>
                      <div class="row">
                        <div class="col-md-6"> 
                          From: <?php echo $row['user_email']; ?> <br>
                          Forum Link: <?php echo '<a href="forum.php?id='.$row['concern_id'].'"> See Forum </a>'; ?>
                        </div>
                        <div class="col-md-6 text-right">
                          <?php echo $row['date_reply']; ?>
                          <br>
                          <?php echo $row['time_reply']; ?>
                        </div>
                      </div>
                      <h3>Message:</h3>
                      <div class="card">
                      ...
                      <div class="card">
                        <div class="container">
                          <h3> Your Concern: </h3> <br>
                         Type: <?php echo $row['type']; ?> <br> <br> 
                         Question: <?php echo $row['question']; ?> <br> <br>
                         Concern:  <?php echo $row['concern']; ?> <br> <br>
                        Concern Image:  <?php if ($row['image'] == "") {
                                echo "No Image Included";
                              }
                              else {
                      ...
                      <div class="card" id="yourConcern" style="display: none;"> 
                              <div class="container">
                                <span>Do you have more question regarding to this topic? Send your question.</span> 
                                <form method="post" action="viewReply.php?rep_id=<?php echo $row['rep_id']; ?>" enctype="multipart/form-data">
                                  ...
                                  <input type="text" name="id_con" hidden="" value="<?php echo $row['concern_id']; ?>">
                      ...
                      <div class="pull-left">
                        <a href="inbox.php" class="btn btn-danger btn-round"><i class="fa fa-mail-reply"></i> Back </a> 
                      </div>
                      <div class="pull-right">
                        <button class="btn btn-info btn-round" id="viewConcernOwn"><i class="fa fa-comments"></i> Reply to this Topic </button> 
                      </div>
                    </div>
                    </div>
                  </div>
